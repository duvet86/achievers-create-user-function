...
export interface StudentForm {
  ...
  "IS ENGLISH THE MAIN LANGUAGE SPOKEN IN THE STUDENT'S HOUSEHOLD? ": YesNoAnswer;
  ...
  "The Achievers Club runs every Saturday during the school term, from 10:00 AM to 12:00 PM.\n\nIs your child able and willing to commit to attending each week?": YesNoAnswer;
  "PLEASE READ THE STATEMENTS BELOW AND INDICATE YOUR AGREEEMENT BY CHECKING EACH BOX: ": string[];
  "If this application is successful, I give permission for the Club—and its approved third parties, such as sponsors—to use and publish photographs of me and/or my child in print, digital, or online materials for the purpose of promoting the activities of the Club or its sponsors.\n(You may choose to decline permission. Doing so will not affect your application. If you have any concerns regarding the use of photographs, please let us know.)": YesNoAnswer;
  "This form must be signed by a parent or guardian (over 18 years of age).\nPlease type your full name below as a digital signature. A hard copy will be provided for you to sign in person on your child’s first day at the Club.": string;
  "DATE: ": string;
}
